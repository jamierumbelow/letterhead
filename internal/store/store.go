...
// CountMessagesForAccount is an alias for CountMessages.
func (s *Store) CountMessagesForAccount(ctx context.Context, accountID string) (int, error) {
	return s.CountMessages(ctx, accountID)
}
...
// CountThreadsForAccount is an alias for CountThreads.
func (s *Store) CountThreadsForAccount(ctx context.Context, accountID string) (int, error) {
	return s.CountThreads(ctx, accountID)
}
